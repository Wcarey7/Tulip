...
private:
    ...
    std::shared_ptr<Tulip::Shader> m_Shader;
    std::shared_ptr<Tulip::VertexArray> m_VertexArray;

    std::shared_ptr<Tulip::Shader> m_FlatColorShader, m_TextureShader;
    std::shared_ptr<Tulip::VertexArray> m_SquareVA;

    std::shared_ptr<Tulip::Texture2D> m_Texture;
