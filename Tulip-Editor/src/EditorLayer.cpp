...
#include "Tulip/Utils/PlatformUtils.h"
#include "Tulip/Math/Math.h"
...
namespace Tulip
{
    ...
    {
        TULIP_CORE_ASSERT(m_SceneState == SceneState::Play || m_SceneState == SceneState::Simulate);
